...
public class XMLConfirmationReservation extends TestCase {
    @Test
    public void testXMLParser() throws Exception{
        String path ="src/main/data/soulaimane.xml";

        ConfirmationReservation confirmationReservation = ConfirmationReservation.xmlToObject(path);

        System.out.println(confirmationReservation.toString());
