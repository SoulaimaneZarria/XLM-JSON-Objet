...
public class ConfirmationReservationToXML extends TestCase {
    @Test
    public void testObjectToXML() throws Exception{

        String path = "src/main/data/xmltestfile.xml";
        ...
        ConfirmationReservation.objectToXML(confirmationReservation, path);
        File file = new File(path);

        // test file exsite and not empty
        assertNotNull(file);
